...
public class Claim {
    ...
    public Claim(Long id, String description, Date date, String status, Long policy_id, Policyholder policyholder,
            Adjuster adjuster, Underwriter underwriter, Investigator investigator, Investigation investigation) {
        this.id = id;
